...
public class LoginTeste {
	...
	By btnAdicionar = By.xpath("//div[@class='inventory_list']//div[@class='inventory_item'][1]//button[text()='ADD TO CART']");
	By btnRemover = By.xpath("//div[@class='inventory_list']//div[@class='inventory_item'][1]//button[text()='Remove']");
	...
	public void testLoginValido() {
		...
		driver.findElement(campoFirstName).sendKeys("Anderson");
		driver.findElement(campoLastName).sendKeys("Barbosa");
